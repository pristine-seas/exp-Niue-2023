...
tmp_plot <- biomass_by_taxa |> 
  ...
  scale_y_log10()+
  labs(y = "Abundance (Ind x 100m2)", x = "Frequency (% station-strata)", col = "Trophic group", size = "Biomass")+
  ggthemes::theme_hc()+
...
biomass_by_strata_combined |> 
  ...
  labs(title = 'Changes in fish biomass between 2016 and 2023',
       subtitle = "Niue",
...
ggsave(file.path(exp_path, "figures/fish_biomass_2016_2023_boxplot_no_outliers_niue.pdf"))
```
