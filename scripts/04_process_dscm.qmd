...
dscm_meta <- dscm_meta |> 
  ...
  mutate(lead_operator = "Whitney Goodell",
         ...
         deployment_time = lubridate::ymd_hms(deployment_time, tz = "Pacific/Niue"),
         recovery_time = lubridate::ymd_hms(recovery_time, tz = "Pacific/Niue"),
...
dscm_meta <- dscm_meta |> 
  mutate(sublocation = NA_character_,
         extech_expedition_id = NA_character_) |> 
...
all_deployments <- all_deployments |> 
  filter(ps_expedition_id != "NIU_2023") |> 
  bind_rows(dscm_meta) |> 
